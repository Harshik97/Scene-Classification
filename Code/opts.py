...
def get_opts():
    ...
    ## Paths
    parser.add_argument('--data-dir', type=str, default='/Users/harshikrampal/Desktop/CV/HW1/code/data',
                        help='data folder')
    parser.add_argument('--feat-dir', type=str, default='../feat',
                        help='feature folder')
    parser.add_argument('--out-dir', type=str, default='/Users/harshikrampal/Desktop/CV/HW1/code/data',
                        help='output folder')

    ## Visual words (requires tuning)
    parser.add_argument('--filter-scales', nargs='+', type=float,
                        default=[1,2], #[1,2,4,4,8,14]
